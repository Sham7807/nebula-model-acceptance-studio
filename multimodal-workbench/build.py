...
html = html.replace('<script src="report-theme.js"></script>', theme_script)
...
for script in ['model-discovery.js', 'choice-picker.js', 'model-multiselect.js', 'prompts.js', 'history-capture.js', 'gpt-suite.js', 'acceptance.js', 'history.js', 'general-check-content.js']:
